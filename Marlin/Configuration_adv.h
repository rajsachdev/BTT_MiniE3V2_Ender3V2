...
//
#define ASSISTED_TRAMMING  //rajs2 experim
  ...
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first //rajs2 experim

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu//rajs2 experim

  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, Y_CENTER, 30 } // Move the nozzle out of the way for adjustment //rajs2 experim
...
#define MICROSTEP_MODES { 32, 32, 32, 16, 16, 16 } // [1,2,4,8,16]
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE  32//8 //rajs
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 64 //16 //rajs
#else
  #define BLOCK_BUFFER_SIZE 64 //16  //rajs
#endif
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       580 //850        // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define  X_SLAVE_ADDRESS 0 //change-rajs
   ...
   */
  #define MONITOR_DRIVER_STATUS   //rajs trial
