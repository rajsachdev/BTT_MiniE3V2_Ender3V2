...
#define CUSTOM_MACHINE_NAME "Ender-3 V2.7"  //   2.7 btt 512 and usb as usb was not working, also enabled tramming, previous good  2.6 working with Sunon fan control , previous good 2.3
...
#define TEMP_SENSOR_BED 1   //change-rajs
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 270.2 }
 ...
 */
//#define S_CURVE_ACCELERATION //to and try change-rajs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {  -44, -8, -1.2 } //change-rajs
...
#define X_MIN_POS -10 //micsorswiss DD rajs
#define Y_MIN_POS -10 //microswiss DD rajs
#define Z_MIN_POS 0
...
#define FILAMENT_RUNOUT_SENSOR  //change-rajs
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7   //change-rajs
    ...
    #define FILAMENT_MOTION_SENSOR  //change-rajs //experimental
  #endif
#endif
...
//#define AUTO_BED_LEVELING_UBL   //change-rajs
...
#define FAN_SOFT_PWM  //rajs experimental for sunon fans
